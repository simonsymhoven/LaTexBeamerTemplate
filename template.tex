...
\title{Docker Compose: \\ Beispiel DB \& UI mit IntelliJ IDEA und Maven}

\subtitle{MongoDB \& Spring}

\author{Simon Symhoven}

\institute{simon.symhoven@hm.edu \\ Fakultät für \\ Informatik und Mathematik}

\titlegraphic{\includegraphics[scale=0.2]{Images/hmlogo.png}} % Optional title page image, comment this line to remove it
